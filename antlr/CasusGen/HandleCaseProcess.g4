// Automatically generated by EDJ BPEL2CFG Transformer : Wed Jul 18 21:55:46 CEST 2018
...
JXPathContext reinjectionCtx = JXPathContext.newContext(reinjection);
varMap.put("reinjection", reinjectionCtx);
...
registerCaseRequest.parameters.requestInput.id = handleCaseInput.payload.id;
registerCaseRequest.parameters.requestInput.type = handleCaseInput.payload.type;
registerCaseRequest.parameters.requestInput.errorIndicator = handleCaseInput.payload.errorIndicator;
}
'InvokeRegisterCase'
...
getCalculationRequest.parameters.requestInput.id = handleParkedCaseInput.parameters.id;
}
...
stopCaseRequest.parameters.requestInput.id = stopCaseInput.parameters.id;
stopCaseRequest.parameters.requestInput.errorIndicator = stopCaseInput.parameters.errorIndicator;
}
'InvokeStopCase'
...
registerObjectionCaseRequest.parameters.requestInput.id = handleObjectionInput.parameters.id;
registerObjectionCaseRequest.parameters.requestInput.type = handleObjectionInput.parameters.type;
}
...
( 'IfNewObjection' { handleObjectionInput.parameters.type.equals("New") }?
...
| 'else' { !handleObjectionInput.parameters.type.equals("New") }?
